...
function LoginCard() {
        ...
        return (
            ...
            '>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <p className='georama-b text-xl text-textColorLight'>Hey</p>
                    <p className='georama-l text-xs text-textColorLight'>Pls Login</p>
                </div>
                <div className='w-full flex flex-col gap-[5px]'>
                    <div className='w-full'>
                        <Input 
                        className='w-full text-textColorLight'
                        value={email}
                        isInvalid={isInvalid}
    ...
    if(forgotPass){
        return (
            ...
            '>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <p className='georama-b text-xl text-textColorLight'>Hey</p>
                    <p className='georama-l text-xs text-textColorLight'>Pls enter your registered email</p>
                </div>
                <div className='w-full'>
    ...
    return (
        ...
        '>
            ...
            <div className='flex flex-col items-center justify-center'>
                <p className='georama-b text-xl text-textColorLight'>Hey</p>
                <p className='georama-l text-xs text-textColorLight'>Pls enter OTP sent on your Email</p>
            </div>
            <div className='w-full'>
            <div className='otpArea flex items-center justify-center'>
                <OtpInput
            ...
            <div className="w-[100%] flex justify-end gap-[1rem] text-textColorLight">
